 ...
 */
vector<int> buildDijkstra(vector<halfedge *> HalfEdges, vector<vertex *> Sommets, int origine, int destination, int flag);
...
*/
void construire(vector<halfedge *>, int origine, int flag);
